	<cf_checkSession assetdesired ="0" purchasedesired = "1"/>
	<cfparam name="res" default="" type="string"> 
	<cfif not structIsEmpty(FORM) and structKeyExists(FORM,"submit")>
		<cfset res = APPLICATION.com.control.admin.feedback(FORM) /> 
	    <script>
...
<script>
  ...
  var dovalidate = function(){
  		var ret = false;
  		  $("#validationMsg").html('');
  		if( (document.getElementById('req_cls_0').checked || document.getElementById('req_cls_1').checked) &&
  			(document.getElementById('req_ful_0').checked || document.getElementById('req_ful_1').checked)&& 
  			(document.getElementById('req_sat_0').checked || document.getElementById('req_sat_1').checked))
  			{
    		ret = true;
    		    		}
    	else{
    	    		document.getElementById("message").style.display = 'block';	
    	    $("#validationMsg").html('<span class="alert">Please do not leave any questions unanswered</span>');	
    	}
    		return ret;
        };
</script>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->Feed Back<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
							...
							<cfform name="feedbackform" id="feedbackform" action="feedback.cfm" method="post" onSubmit="return dovalidate();">
								<div id="message" style="display:none">
								 <table>
									<tr>
		                            	<td width="300px" style="color:red"  class="content">
		                         			 <span id="mesg" >&nbsp; </span>
		                         			  <div id="validationMsg"></div> </td>
		                            </tr>
	    	                   </table>
							</div> 
						  <table>
							...
							<tr>
								...
								<td class="content" > 
								<cfinput type="text" name="PO" autosuggest="cfc:#APPLICATION.hardRoot#control/adminman.POAutoSuggest({cfautosuggestvalue})"
							 ...
							 <table>
                          	<tr>
                            	<td class="content" >
									Can We consider your Request Closed? &nbsp;&nbsp;
									Yes<input type="radio" name="req_cls" id="req_cls_0"  value="Yes" >&nbsp;&nbsp;
									No<input type="radio" name="req_cls"  id="req_cls_1" value="No">
	                                </td>
                          	...
                          	<tr>
                            	<td class="content" >
									Have we fulfilled your requirements? &nbsp;&nbsp;
									Yes<input type="radio" name="req_ful" id="req_ful_0"  value="Yes" >&nbsp;&nbsp;
									No<input type="radio" name="req_ful" id="req_ful_1" value="No">
	                                </td>
                          	...
                          	<tr>
                            	<td class="content" >
									...
									Yes<input type="radio" name="req_sat"  id="req_sat_0" value="Yes" >&nbsp;&nbsp;
									No<input type="radio" name="req_sat" id="req_sat_1" value="No">
	                                </td>

                            </tr>
                          	<tr>
                            	<td class="content" >
									If you replied "No" to any of the above questions, please provide further details &nbsp;&nbsp;
                          	...
                          	<tr>
                            	<td class="content" >
									<textarea name="reason"  cols="75" rows="5"></textarea>
	                                </td>
                            </tr>
							<tr>
                            	  <td class="content"><input type="submit" name="submit"  value="Send" ></td>
                          	  </tr>
                          </table>
							</cfform>
