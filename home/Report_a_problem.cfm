...
<script>
	...
	myMenu.idMenuInit = 'report_a_problem';	
</script>
<!-- InstanceEndEditable -->
</head>
<body>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->Report a problem<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <table width="226">
                          	<tr>
                            	<td width="64" class="content">
                                	Related to                                </td>
                                <td width="150" class="content"><select name="relatedto" id="relatedto">
                          	...
                          	<tr>
                          	  ...
                          	  <td class="content"><textarea name="message" id="message" cols="15" rows="2"></textarea></td>
                        	  </tr>
                          	<tr>
                          	  <td class="content">&nbsp;</td>
                          	  <td class="content"><input type="submit" name="submit" id="submit" value="Submit"></td>
                        	  </tr>
                          </table>  
