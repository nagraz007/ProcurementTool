...
<!-- InstanceBeginEditable name="MenuId" -->
    ...
    <script src="../js/jquery_validate_1.5.2.js"></script>
    <!--- Fin JS --->
    
<script>
	myMenu.PathToTheRoot = "../";
	myMenu.idMenuInit = 'accesslevels';
	 $(document).ready(
  function() {
   $("#addrole").validate({
	   		messages: { 
					name:"<span class='alert' style='font-size:16px;'><strong>&nbsp;!</strong></span>"
				}
	   });
   $("#asgnRole").validate({
		messages: { 
				user:"<span class='alert' style='font-size:16px;'><strong>&nbsp;!</strong></span>"
			}
   });
   $("#asset_permissions").hide();
   $("#purchase_permissions").hide();
   $("#assets2").click(function(){
  $("#asset_permissions").show();
   $("#purchase_permissions").hide();
  });	
    $("#purchasing2").click(function(){
   $("#asset_permissions").hide();
  $("#purchase_permissions").show();
  });	
  
     });
    function togglerole() 
    {
	var ele = document.getElementById("addroles");
    ...
    function toggleassignrole() 
    {
	var ele = document.getElementById("asgnroles");
		if(ele.style.display == "block") {
    			ele.style.display = "none";
  		}
		else {
    ...
    function toggleSeeAllPerm() 
    {
	var ele = document.getElementById("seeAllPerm");
		if(ele.style.display == "block") {
    			ele.style.display = "none";
  		}
		else {
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->Access Levels<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <!--- The Way Permission Levels are Created 
						...
						1 --  View (Search)			1 --  Purchase Request
												
						2 --  Add					2 --  Budget Approvals
						
						3 --  Edit					3 --  All
						
						4 --  Admin					4 --  Admin  
						
						5 --  IT Admin				5 --  IT Admin
								
													Assets						Purchasing
					
						User 				-->			0							1
						IT OSS 				-->			1							1
						Budget Controller 	-->			2							2
						Purchasing Officer  -->			3							3
						Purchasing Admin 	-->			4							4
						ITAdmin 			-->			5							5
					...
					--->  
						...
						<table>
                         	<!--- <tr>
                         	  <td height="33" class="content"><a href="javascript:togglerole();" > Add New Role</a></td>
                       	  </tr>
                         	<tr> --->
                         	  <td class="content"><a href="javascript:toggleassignrole();"> Assign Role to User</a></td>
                       	  </tr>
                         </table>
                        	<!--- <form name="addrole" id="addrole" action="accesslevels.cfm" method="post"> 
						<div id="addroles" style="display: none">
						<table>
                         	<tr>
                            	<td width="84" class="content" >
                                	Name                                </td>
                                <td width="231" class="content" ><input type="text" name="name" id="name" class="required limited" maxlength="30"></td>
                                </tr>
                         	<tr>
                         	  <td height="52" class="content" >Role for </td>
                         	  <td class="content" ><input  type="radio" name="assets2" id="assets2" value="0">
                         	    Assets                         	      <br>
                         	    <input  type="radio" name="assets2" id="purchasing2" value="1">
                         	    Purchasing</td>
                         	  </tr>
                         	<tr id="asset_permissions">
                         	  <td height="59" class="content" >Permissions</td>
                         	  <td class="content" ><input type="checkbox" name="view"  value="1	">
                         	    View 
                         	      <input type="checkbox" name="add"  value="2" >
Add                         	      
<input type="checkbox" name="edit" value="4">
                         	      Edit and Delete<br></td>
                         	  </tr>
                         	<tr id="purchase_permissions">
                         	  <td height="76" class="content" >Permissions</td>
                         	  <td class="content" ><input type="checkbox" name="approvereq"  value="1">
Approve Reqests<br>                        	    
  <input type="checkbox" name="purchActions" value="2">
  Purchase Actions<br>
  <input type="checkbox" name="budgetApproval" value="4"> 
  Budget Approvals</td>
                         	  </tr>
                         	<tr>
                         	  <td class="content" >&nbsp;</td>
                         	  <td class="content" ><input type="submit" name="addnewrole" value="Add new Role"></td>
                         	  </tr>
                         </table>
                        	</div>
						      </form> --->
                        	<cfform name="asgnRole" id="asgnRole" method="post" action="accesslevels.cfm">
							<div id="asgnroles" style="display:none">
						 <table width="261">
						 	<tr>
                            	<td width="71" class="content">
                                User<span class="alert">*</span></td>
                                <td width="178" class="content"><cfinput type="text" name="user" id="user" 
								autosuggest="cfc:#APPLICATION.hardRoot#control/adminman.autosuggestusers({cfautosuggestvalue})" autoSuggestMinLength="4"  showAutosuggestLoadingIcon="true" class="required"></td>
                         	</tr>
                         	<tr>
                         	  <td class="content">Category<span class="alert">*</span></td>
                         	  <td class="content"><input type="radio" name="assets" value="0" >
                         	    Assets 
                         	      <input type="radio" name="assets" value="1" >
                         	      Purchasing</td>
                       	  </tr>
                         	<tr>
                         	  <td class="content">Role<span class="alert">*</span></td>
                         	  <td class="content"><cfselect     name="roleId" 
    bind="cfc:#APPLICATION.hardRoot#control/adminman.listAccessRoles({asgnRole:assets})"
    bindOnLoad="false"
    value="id"
    display="role"
		/>
                         	...
                         	<tr>
                         	  <td class="content">&nbsp;</td>
                         	  <td class="content"><input type="submit" name="assign" value="Assign"></td>
                       	  </tr>
						</table>
							</div>
							</cfform> 
							...
							<cfif not structIsEmpty(FORM)>
								<cfif structKeyExists(FORM,"addnewrole")>
									<!--- <cfscript>
										 result = APPLICATION.com.control.admin.addAccessRole(FORM);
									</cfscript>  --->
								<cfelseif structKeyExists(FORM,"assign")>
									<cfscript>
										result = APPLICATION.com.control.admin.assignAccess(FORM);
									</cfscript> 
								</cfif>
							</cfif>
