<cf_checkSession assetdesired ="-1" purchasedesired = "1"/>
<cfsilent>
...
<script>
  ...
  {
  	current = current + 1;
	var strAdd = '<table class="append'+current+'"><tr><td class="content"><strong> Item'+current+'</strong></td></tr><tr><td class="content">Type<span class="alert">*</span></td><td class="content"><select name="purchasetype'+current+'" id="purchasetype'+current+'" onchange="loadSubCat('+current+',this.value)">'+ makePurchaseTypes() +'</select> </td></tr><tr><td height="40" class="content">Model<span class="alert">*</span></td><td class="content"><select name="model'+current+'" id="model'+current+'" class="required"></select></td></tr><tr><td height="103" class="content">Description</td><td class="content"><textarea name="description'+current+'" cols="20" rows="3" id="description'+current+'"></textarea></td></tr><tr><td class="content">Quantity<span class="alert">*</span></td><td class="content"><input type="text" name="quantity'+current+'" class="required number" id="quantity'+current+'"></td></tr></table>';
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
						...
						<table width="466" border="0" >
                        <tr>
                              <td width="91" class="content">Budget ID<span class="alert">*</span></td>
                              <td width="365" class="content"><input type="hidden" name="itemcount" id="count" value="1">
								<input type="text" name="budgetid" id="budgetid" class="required"></td>
                            </tr>
                        <tr>
                        ...
                        <tr>
							...
							<tr>
                              <td width="91" class="content">Incident Number</td>
                              <td width="365" class="content">
								<input type="text" name="incident" id="incident"></td>
                            </tr>
						 <tr>
                          	<td class="content"><strong> Item1</strong></td>
                          </tr>  
                          <tr>
                            <td class="content">Type<span class="alert">*</span></td>
                          <td class="content">
                            ...
                            <tr>
                              <td height="40" class="content">Model<span class="alert">*</span></td>
                            ...
                            <tr>
                              <td class="content">Quantity<span class="alert">*</span></td>
