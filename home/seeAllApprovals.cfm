...
<script>
	...
	myMenu.idMenuInit = 'seeallapproval';
</script>
<!-- InstanceEndEditable -->
</head>
<body>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->Budget Approvals<!-- InstanceEndEditable --></td>
                        ...
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
							...
							<cfform name="listpermissions">
                         	<cfgrid name="AllPermissions" format="html"  height="390" width="650"
									    font="Verdana" fontsize="12" pagesize="15"  
									   bind="cfc:#APPLICATION.Hardroot#control/purchasing.SeeAllApprovalsForGrid({cfgridpage},{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})"
									   >
										     <cfgridcolumn name="ins_purchaseid" header="PO##" width="90"  />
										   	 <cfgridcolumn name="name" header="Requester" width="160"/>
									    	 <cfgridcolumn name="budgetid" header="Budget ID" width="70"/>
										     <cfgridcolumn name="budgetman" header="Budget Manager" width="160" />
										     <cfgridcolumn name="button" header="Decision" width="70" />
										     <cfgridcolumn name="budgetmgrcomments" header="Comments" width="80" />
							</cfgrid> 
