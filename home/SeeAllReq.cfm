            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->See All Requests<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
						...
						<cfform name="listrequestsGrid">
							<table id="all">
								<tr>
									<td>
                         		<cfgrid name="AllRequests" format="html"  height="390" width="600"
									    font="Verdana" fontsize="12" pagesize="15"  
									   bind="cfc:#APPLICATION.hardroot#control/requests.ListAllrequestsForGrid({cfgridpage},{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})"
									>
									    	 <cfgridcolumn name="name" header="Name" Width="220" />
										   	 <cfgridcolumn name="firstcreatedon" header="Requested Date" Width="190"/>
										   	 <cfgridcolumn name="onbehalfof" header="On Behalf Of" Width="220"/>
										     <cfgridcolumn name="request_status" header="Request Status" Width="80" />
								</cfgrid> 
									</td>
									</tr>
									</table>
