...
<cfif not structIsEmpty(FORM) and structKeyExists(FORM,"btn_submit")>
	<cfscript>
		APPLICATION.com.control.admin.AddDepartment(FORM);
	</cfscript>
</cfif>
...
$(document).ready(function() {
	   ...
	   $("#AddDeptForm").validate({
	   	messages: { 
					DeptName:"<span class='alert' style='font-size:16px;'><strong>&nbsp;!</strong></span>"
				}
	   });
...
var chkDeptnameUnique = function(DeptName){
    $.getJSON("/<cfoutput>#APPLICATION.Hardroot#</cfoutput>control/adminman.cfc", {
        method: 'chkDeptName',
        DeptName: DeptName,
        returnformat: 'json'
    }, function(isDeptnameUnique){
        if (isDeptnameUnique != true) {
            $("#theErrorDivID").html('<span class="alert">Department Name is valid</span>');
			ret = true;
		<!--- 	$("#btn_submit").show(); --->
        }
        else {
            $("#theErrorDivID").html('<span class="alert">Please select a new Department Name</span>');
			<!--- $("#btn_submit").hide(); --->
			ret = false;
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->Departments Section<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                         ...
                         <table>
                            	<tr>
                                	<td width="200" class="content"><a href="#" id="AddDept">Add a new Department</a></td>
                                </tr>
                            </table>            
                            <hr width="700" align="left" noshade>
                            <form id="AddDeptForm" name="AddDeptForm" method="post" action="departments.cfm" onsubmit="return dovalidate();">
                            	<table>
                                	<tr>
                                    	<td class="content">Department Name<span class="alert">*</span></td>
                                        <td class="content">
                                        <input type="text" name="DeptName" id="DeptName" class="required limited" maxlength="50" onchange="chkDeptnameUnique(this.value);">
