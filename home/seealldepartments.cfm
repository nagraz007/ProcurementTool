            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->See All Departments<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <table  id="viewdept">
                            	<tr>
                                	<td><hr width="700" align="left" noshade>
		                                      <cfform name="listdepartments" id="listdepartments">
											             <cfgrid name="DeptList" format="html"  height="300" width="230"
											             font="Verdana" fontsize="12" pagesize="10" selectmode="edit"
											             bind="cfc:#APPLICATION.hardroot#control/adminman.ListDepartmentsforGrid({cfgridpage},
											             {cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})"
											                                        onchange ="cfc:#APPLICATION.hardroot#control/adminman.editForGrid_Department({cfgridaction},{cfgridrow},{cfgridchanged})"
											            >
		               
									               <cfgridcolumn name="name" header="Department_Name" width="300"/>
									               <cfgridcolumn name="depart_id" header="depart_id"  display="no"/>
		          										</cfgrid>
		         								</cfform>
                                    </td>
                                </tr>
