...
<cfif not structIsEmpty(FORM) and structKeyExists(FORM,"add")>
	<cfscript>
		APPLICATION.com.control.admin.addModel(FORM);
	</cfscript>
</cfif>
...
<script>
	...
	myMenu.idMenuInit = 'itemmodel';
	$(document).ready(function() {
		/*Jquery for form Validation*/
	   $("#AddItemModel").validate({
	   		messages: { 
					modelname:"<span class='alert' style='font-size:16px;'><strong>&nbsp;!</strong></span>",
					itemType:"<span class='alert' style='font-size:16px;'><strong>&nbsp;!</strong></span>"
				}
	   });
	...
	var chkModelnameUnique = function(modelname){
    $.getJSON("/<cfoutput>#APPLICATION.Hardroot#</cfoutput>control/adminman.cfc", {
        method: 'chkItemModelName',
        modelname: modelname,
        returnformat: 'json'
    }, function(isModelUnique){
        if (isModelUnique != true) {
            $("#theErrorDivID").html('<span class="alert">Model name is valid</span>');
			$("#add").show();
        }
        else {
            $("#theErrorDivID").html('<span class="alert">Please select a new Item Model Name</span>');
			 $("#add").hide();
        }
    });
};
...
<style type="text/css">
	...
	.note {float:none; color:#006E51; vertical-align: top; font-style:italic;}
	.heading {float:none; color:#006E51; vertical-align: top; font-style:inherit; text-decoration:underline}
</style>
<!-- InstanceEndEditable -->
</head>
<body>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->Item Models<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
							<table>
                            	<tr>
                                	<td class="content"><a href="#" id="addmodel">Add Item Model</a></td>
                                </tr>
                            </table>
                            <hr width="700" align="left" noshade>
                            
                            <cfform id="AddItemModel" name="AddItemModel" method="post" action="itemmodel.cfm">
                            <cfset typeList = APPLICATION.com.control.admin.ListPurchaseItemTypes().data />
                            	<table>
                                	<tr>
                                    	<td class="content">Select the Purchase Item Type<span class="alert">*</span></td>
                                        <td class="content">
                                        	<cfselect name="itemType" id="itemType" query="typeList" display="name" value="id" class="required"></cfselect>
                                        </td>
                                    </tr>
                                	<tr>
                                    	<td class="content">Item Model Name<span class="alert">*</span></td>
                                        <td class="content">
                                        	<input type="text" id="modelname" name="modelname" class="required limited" maxlength="30" onchange="chkModelnameUnique(this.value);">
