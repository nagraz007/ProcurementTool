            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->Search Asset<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
                            	   <cfform name="drop_list" id="drop_list" method="post" action="searchasset.cfm">
							...
							<cfif not structIsEmpty(FORM) and structKeyExists(FORM,"search")>
								<cfif compareNoCase(FORM.param,'Products') eq 0>
									<cfform name="productGrid">
									    ...
									    font="Verdana" fontsize="12" pagesize="15"
									  	...
									  	>
										     ...
										     <cfgridcolumn name="owned_leased" header="Owned/Leased"/>
										     <cfgridcolumn name="serialno" header="Serial"/>
										     <cfgridcolumn name="budgetid" header="Budget Id" width="60"/>
										     <cfgridcolumn name="date_started" header="Date Started"/>
										     ...
										     <cfgridcolumn name="inspurchaseid" header="PurchaseId"/>
								...
								<cfif compareNocase(FORM.param,'Softwares') eq 0>
									<cfform>
									    ...
									    font="Verdana" fontsize="12" pagesize="15"  
									   	...
									   	{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection},'#FORM.subparam#','#FORM.searchword#')"
									  	>
									    	  <cfgridcolumn name="software_id" header="Software ID" display="false" />
									    	 <cfgridcolumn name="name" header="Name"/>
									    	 <cfgridcolumn name="model" header="Model"select="no" />
										     <cfgridcolumn name="duration" header="Duration" select="no"/>
										     <cfgridcolumn name="durationtype" header="Duration Type" select="no"/>
										     <cfgridcolumn name="startdate" header="Start date"/>
										      <cfgridcolumn name="enddate" header="End date"/>
										     <cfgridcolumn name="type_of_software" header="Type Of Software" />
										     <cfgridcolumn name="vendor_name" header="Vendor"/>
										     <cfgridcolumn name="old_new" header="Old/New" />
										     <cfgridcolumn name="inspurchaseid" header="PurchaseId"/>
										     <cfgridcolumn name="purchaseid_old" header="Old Purchase Id"/>
										     <cfgridcolumn name="Termination_notice" header="Temination Notice"/>
										     <cfgridcolumn name="NoticeRequirement" header="Notice Requirement"/>
										</cfgrid>
									</cfform>
								</cfif>
