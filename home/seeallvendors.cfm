...
<script>
	...
	myMenu.idMenuInit = 'seeallvend';

		function init(){

<cfoutput>#APPLICATION.com.util.ForEditableGrid('VendorsList', 'GLOCATION','glocation')#</cfoutput>

}
	 function act_s(type, s_id){
	 			document.listvendors.vendorid.value = s_id;
	 			document.listvendors.type.value = type;
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->See All Vendors<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
								...
								<cfform name="listvendors">
                           <table id="listVendors" height="390">
                          	<tr>
                            	<td class="content">
									    <cfgrid name="VendorsList" format="html"  height="390" width="705"
									    font="Verdana" fontsize="12" pagesize="15" selectmode="edit"
									   	bind="cfc:#APPLICATION.hardroot#control/adminman.resultForGrid_Vendors({cfgridpage},
									   	{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})"
									  	onchange ="cfc:#APPLICATION.hardroot#control/adminman.editForGrid_Vendors({cfgridaction},{cfgridrow},{cfgridchanged})"
									  	>
									    	 <cfgridcolumn name="VENDOR_NAME" header="Vendor Name"/>
                                             <cfgridcolumn name="DETAIL" header="Vendor Details"/>
                                             <cfgridcolumn name="ADDRESS" header="Address"/>
                                             <cfgridcolumn name="GLOCATION" header="Geographical Location" />
										     <cfgridcolumn name="EMAIL" header="Email ID"/>
										     <cfgridcolumn name="PHONE1" header="Phone 1"/>
                                             <cfgridcolumn name="PHONE2" header="Phone 2"/>
                                             <cfgridcolumn name="FAX" header="FAX"/>
                                             <cfgridcolumn name="button" header="Action"/>
										</cfgrid>
										
										<cfinput name="vendorid" type="hidden" value="0">
							       ...
							       headerStyle="background-color: ##006e51; color:##ffffff ; " 
							        ...
							        source="expVendor.cfm?vendor_id={listvendors:vendorid}&type={listvendors:type}" 
							        />
