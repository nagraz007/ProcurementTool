...
<script>
	...
	myMenu.idMenuInit = 'budgetapprovals';	
                        ...
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
                           ...
                           <cfajaximport tags="cfform,cfinput-autosuggest,cfwindow">
							<cfform name="bapproval" id="bapproval" action="" method="post">
								<cfdiv ID="theDiv" style="width:100%" />
							    <cfinput type="hidden" name="hiddentext" value="0" />
							</cfform>
								<cfwindow  x="210" y="100" center="false" width="700" height="700" name="POdisplay"
							       ...
							       headerStyle="background-color: ##006e51; color:##ffffff ; " 
							        title="Detail of Purchase Order" initshow="false"
							        source="po.cfm?purchase_id={bapproval:hiddentext}" 
							        />
								
							<script type="text/javascript">
								ColdFusion.navigate('../components/control/purchasing.cfc?method=listPO','theDiv');
								var fillHdntxt = function(a){
									document.bapproval.hiddentext.value = a;
									ColdFusion.Window.show('POdisplay');
									ColdFusion.Window.onHide('POdisplay', onhide);		
								};
