...
<script>
	...
	myMenu.idMenuInit = 'seeallperm';
</script>
<script>
		function init(){

<cfoutput>#APPLICATION.com.util.ForEditableGrid('AllPermissions', 'ASSETROLE','assetrole')#</cfoutput>
<cfoutput>#APPLICATION.com.util.ForEditableGrid('AllPermissions', 'PURCHASEROLE','purchaserole')#</cfoutput>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->All Permissions<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
							...
							<cfform name="listpermissions">
                         	<cfgrid name="AllPermissions" format="html"  height="390" width="560"
									    font="Verdana" fontsize="12" pagesize="15" selectmode="edit" 
									   bind="cfc:#APPLICATION.hardroot#control/adminman.SeeAllPermissionsForGrid({cfgridpage},{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})"
									   	onchange="cfc:#APPLICATION.hardroot#control/adminman.EditPermissionsForGrid({cfgridaction},{cfgridrow},{cfgridchanged})">
										   	 <cfgridcolumn name="username" header="Login Name" width="120"/>
									    	 <cfgridcolumn name="name" header="Name" width="180"/>
										     <cfgridcolumn name="assetrole" header="Asset Role" width="130"  />
										     <cfgridcolumn name="purchaserole" header="Purchasing Role" width="130" />
							</cfgrid> 
