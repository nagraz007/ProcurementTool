...
<script>
	...
	myMenu.idMenuInit = 'seeallmodels';
</script>
<!-- InstanceEndEditable -->
</head>
<body>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->All Models<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
                                    ...
                                    <cfform name="viewModels" id="viewModels">
					<table id="viewModelstable">
                                <tr>
                                	<td class="content">
									    <cfgrid name="viewModels" format="html"  height="390" width="350"
									    font="Verdana" fontsize="12" pagesize="15" selectmode="edit"
									   	bind="cfc:#APPLICATION.hardroot#control/adminman.viewModelsForGrid({cfgridpage},
									   	{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})"									  	
                                        onchange ="cfc:#APPLICATION.hardroot#control/adminman.editModelsForGrid({cfgridaction},{cfgridrow},{cfgridchanged})"
									  	>
									    	 <cfgridcolumn name="MODEL_ID" header="MODEL_ID" display="no"/>
									    	 <cfgridcolumn name="PURCHASETYPE_ID" header="PURCHASETYPE_ID" display="no"/>
                                             <cfgridcolumn name="MODEL_NAME" header="MODEL_NAME" width="200"/>
                                             <cfgridcolumn name="TYPE_NAME" header="TYPE_NAME" width="150"/>
										</cfgrid>
                                    </td>
                                </tr>
                            </table>
