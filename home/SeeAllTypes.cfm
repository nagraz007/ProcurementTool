            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" -->All Types<!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                       ...
                       <cfform name="viewPurchaseItemTypes" id="viewPurchaseItemTypes">
						<table id="viewtypestable">
                                <tr>
                                	<td class="content">
									    <cfgrid name="viewTypes" format="html"  height="390" width="230"
									    font="Verdana" fontsize="12" pagesize="15" selectmode="edit"
									   	bind="cfc:#APPLICATION.hardroot#control/adminman.viewPurchItemTypesForGrid({cfgridpage},
									   	{cfgridpagesize},{cfgridsortcolumn},{cfgridsortdirection})"
                                        onchange ="cfc:#APPLICATION.hardroot#control/adminman.editForGridPurchaseTypes({cfgridaction},{cfgridrow},{cfgridchanged})"									  	
									  	>
									    	 <cfgridcolumn name="NAME" header="PURCHASE TYPE Name" width="230"/>
