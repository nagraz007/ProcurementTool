	<!--- <cfparam name="postValidation" default="#StructNew()#" type="struct" /> --->
	<cfparam name="URL.errcode" default="" type="string" />
	<cfset page = {message = '',success = false} />
	<cfif not structIsEmpty(FORM) and structKeyExists(FORM,"LOGIN_SUBMIT")>
		<cfset StructClear(SESSION) />
		<cfset page = APPLICATION.com.control.login.validateUser(FORM.username, FORM.codepass) />
		<cfif page.success>
				<cflocation url="index.cfm" addtoken="false" />
		</cfif>
	<cfelseif URL.errcode neq '' >
		<cfset page.message = APPLICATION.com.control.config.getMessageForCode(URL.errcode) />	
	</cfif>
...
<script>
	...
	function dovalidate(){
		...
		var pass = document.loginForm.codepass;
		var ret = true;
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="82%" class="headline"><!-- InstanceBeginEditable name="page title" --> Login <!-- InstanceEndEditable --></td>
                    ...
                    <table width="750" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="520" height="230" align="left" valign="top" class="background_white"><!-- InstanceBeginEditable name="content" -->
                          	...
                          	<table>
                            	<form name="loginForm"  method="post" action="login.cfm" onSubmit="return dovalidate();">
                            	<tr>
                                	<td width="70" class="content">Username</td>
                                    <td width="117" class="content"><input type="text" name="username" /></td>
                            	</tr>
                            	<tr>
                            	  <td class="content">Password</td>
                            	  <td class="content"><input type="password" name="codepass" /></td>
                          	  </tr>
                            	<tr>
                            	  <td class="content">&nbsp;</td>
                            	  <td class="content"><input type="submit" name="login_Submit" value="Submit" /></td>
                          	  </tr>
                              </form>
                            </table>
							<br />
							<table width="100%">
								<tr>
									<td class="content" style="color:red">
										<cfoutput>#page.message#</cfoutput>
									</td>
								</tr>
							</table>
